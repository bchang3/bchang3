...
- and developing the first online Hausa dictionary ([kamusunhausa.hausanlp.org](https://kamusunhausa.hausanlp.org/)). Hausa is the second most used language in Africa, with over 90 million speakers. However, it is still classified as a low-resource language. To make sure that Hausa is well-represented in NLP and LLM models, we also built a  dataset catalog to facilitate future NLP research ([catalog.hausanlp.org](https://catalog.hausanlp.org/))..
